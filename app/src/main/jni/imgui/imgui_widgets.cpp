...
namespace c {
    ...
    inline ImVec4 checkbox_gradient_start = ImColor(21, 144, 237, 255);
    inline ImVec4 checkbox_gradient_end = ImColor(21, 144, 237, 255);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
 ...
 //  it_anim->second.background_slider = ImLerp(it_anim->second.background_slider, IsItemActive() ? c::bg_slider_active : hovered ? c::bg_slider_hov : c::bg_slider, g.IO.DeltaTime * 6.f);
    ...
    window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 8), frame_bb.Max - ImVec2(0, 15), GetColorU32(c::slider_background), 100);
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        ...
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 8), frame_bb.Min + ImVec2(it_anim->second.slow - 4, 25.5f), GetColorU32(c::checkbox_gradient_start), 100, ImDrawFlags_RoundCornersLeft);
        ...
        window->DrawList->AddCircleFilled(frame_bb.Min + ImVec2(it_anim->second.slow - 1, 16.5f), 17, GetColorU32(c::circle_push_gradient), 100);
