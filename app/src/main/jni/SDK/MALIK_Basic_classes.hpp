...
public:
	...
	int                                                iRegionActor;                                             // 0x03C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x03C8(0x0002) MISSED OFFSET
	bool                                               bStaticAddNetworkActor;                                   // 0x03CA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      AutoDormancyType;                                         // 0x03CB(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class APlayerController*                           OwningController;                                         // 0x0340(0x0004) (ZeroConstructor, IsPlainOldData)
