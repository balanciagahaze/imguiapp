...
public:
	...
	unsigned char                                      bAutoRegisterWithBudgetAllocator : 1;                     // 0x0BE8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAutoCalculateSignificance : 1;                           // 0x0BE8(0x0001) (Edit)
	unsigned char                                      bShouldUseActorRenderedFlag : 1;                          // 0x0BE8(0x0001) (Edit)
