...
// Function Creative.CreativeModeBlueprintLibrary.RegisterUGCLuaFunction
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// class UObject*                 LuaVM                          (Parm, ZeroConstructor, IsPlainOldData)
// class UGameInstance*           GameInstance                   (Parm, ZeroConstructor, IsPlainOldData)

void UCreativeModeBlueprintLibrary::RegisterUGCLuaFunction(class UObject* LuaVM, class UGameInstance* GameInstance)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativeModeBlueprintLibrary.RegisterUGCLuaFunction");

	UCreativeModeBlueprintLibrary_RegisterUGCLuaFunction_Params params;
	params.LuaVM = LuaVM;
...
void UCreativeGuideMeshComponent::OnReturnToPool(class UObject* NewOuter, uint32_t RecycledSeq)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
bool UCreativeModeTouchWidget::OnHandleTouchStart(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
bool UCreativeModeTouchWidget::OnHandleTouchMove(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
bool UCreativeModeTouchWidget::OnHandleTouchEnd(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
