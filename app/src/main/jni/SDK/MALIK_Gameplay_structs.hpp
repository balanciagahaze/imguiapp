...
enum class EGridGenerateType : uint8_t
{
	...
	EGridGenerateType__PickUp      = 2,
	EGridGenerateType__EGridGenerateType_MAX = 3
};
...
struct FTLog_PickUpItemFlow
{
	...
	uint64_t                                           OwnerUID;                                                 // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FItemGenerateSpawnClass
{
	...
	TWeakObjectPtr<class AActor>                       AttachedActor;                                            // 0x0084(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x18];                                      // 0x008C(0x0018) MISSED OFFSET
	int                                                SpotIndex;                                                // 0x00A4(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               Random;                                                   // 0x00A8(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               IsStickToTheGround;                                       // 0x00A9(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x2];                                       // 0x00AA(0x0002) MISSED OFFSET
	struct FVector                                     RelativeLoc;                                              // 0x00AC(0x000C) (IsPlainOldData)
};
...
struct FGameModePlayerKnapsackSingleInfo
{
	...
	int                                                HelmetSkin;                                               // 0x000C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                FlySkin;                                                  // 0x0010(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                GrenadeSkin;                                              // 0x0014(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FGameModePlayerConsumableAvatar             ConsumableAvatarList;                                     // 0x0018(0x0010) (BlueprintVisible, BlueprintReadOnly)
	TArray<struct FGameModePlayerItem>                 WeaponList;                                               // 0x0028(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 VehicleSkinList;                                          // 0x0034(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 BackPackPendantList;                                      // 0x0040(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	int                                                ShowVehicleSkin;                                          // 0x004C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                WingmanSkin;                                              // 0x0050(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
};
...
{
	struct FGameModePlayerKnapsackSingleInfo           KnapsackExtInfo;                                          // 0x0000(0x0054) (BlueprintVisible, BlueprintReadOnly)
	bool                                               IsLocked;                                                 // 0x0054(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0055(0x0003) MISSED OFFSET
	int                                                WearIndex;                                                // 0x0058(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
};
...
struct FGameModeAIPlayerParams : public FGameModePlayerParams
{
	...
	bool                                               bBornIslandAI;                                            // 0x0338(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FPlayerStaticInfoInOB
{
	...
	unsigned char                                      UnknownData00[0xC];                                       // 0x000C(0x000C) MISSED OFFSET
	struct FString                                     PlayerOpenID;                                             // 0x0018(0x000C) (ZeroConstructor)
	struct FString                                     PicUrl;                                                   // 0x0024(0x000C) (ZeroConstructor)
...
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) MISSED OFFSET
	int                                                UniqueId;                                                 // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	ERegionSizeIndex                                   RegionSize;                                               // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bBeforeFighting;                                          // 0x0009(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDontTrigger;                                             // 0x000A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FPlayerInfoData : public FResponResult
{
	...
	bool                                               UsePlayerInfoTeamID;                                      // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0029(0x0007) MISSED OFFSET
	int64_t                                            CampID;                                                   // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                PlayerBornPointID;                                        // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FGameModePlayerItem>                 ItemList;                                                 // 0x003C(0x000C) (ZeroConstructor)
	TArray<struct FGameModePlayerExpressionItem>       ExpressionItemList;                                       // 0x0048(0x000C) (ZeroConstructor)
	struct FGameModePlayerEquipmentAvatar              EquipmentAvatar;                                          // 0x0054(0x000C)
	TArray<struct FGameModePlayerRolewearInfo>         AllWear;                                                  // 0x0060(0x000C) (ZeroConstructor)
	struct FGameModePlayerUpassInfo                    UpassInfo;                                                // 0x006C(0x0030)
	int                                                planeAvatarId;                                            // 0x009C(0x0004) (ZeroConstructor, IsPlainOldData)
