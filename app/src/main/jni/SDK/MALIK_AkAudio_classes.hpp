...
{
public:
	class UAkComponent*                                AkComponent;                                              // 0x0338(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	bool                                               StopWhenOwnerIsDestroyed;                                 // 0x033C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               AutoPost;                                                 // 0x033D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UBoxComponent*                               CollisionComponent;                                       // 0x0338(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	TArray<uint16_t>                                   TotalPlayCountRecord;                                     // 0x0020(0x000C) (ZeroConstructor)
	TMap<struct FString, unsigned char>                ObjectPlayCountRecord;                                    // 0x002C(0x0050) (ZeroConstructor)
	TMap<unsigned char, struct FAKErrorInfo>           AkErrorRecord;                                            // 0x0068(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00A4(0x0004) MISSED OFFSET
	struct FScriptDelegate                             AkAudioEventTrigger;                                      // 0x00A8(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	float                                              nPassedTime;                                              // 0x00B8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              nUpdateInterval;                                          // 0x00BC(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<struct FString, int8_t>                       BankRefList;                                              // 0x00C0(0x0050) (ZeroConstructor)
	TArray<struct FString>                             EventList;                                                // 0x00FC(0x000C) (ZeroConstructor)
...
{
public:
	class UAkAuxBus*                                   AuxBus;                                                   // 0x0360(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FString                                     AuxBusName;                                               // 0x0364(0x000C) (ZeroConstructor, Deprecated)
	...
	class UAkLateReverbComponent*                      LateReverbComponent;                                      // 0x037C(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	class UAkLateReverbComponent*                      LateReverb;                                               // 0x0360(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UAkRoomComponent*                            room;                                                     // 0x0364(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	struct FString                                     AuxBusName;                                               // 0x0338(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	class UAkAcousticTexture*                          AcousticTexture;                                          // 0x0344(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
