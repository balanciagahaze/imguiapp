...
public:
	...
	unsigned char                                      bEnableTeamAI : 1;                                        // 0x0448(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0449(0x0003) MISSED OFFSET
	TArray<class UClass*>                              TeamAIClasses;                                            // 0x044C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                SpawnerTeamID;                                            // 0x0458(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBotCategray>                          SpeciesCategory;                                          // 0x045C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x045D(0x0003) MISSED OFFSET
	int                                                SpawnerCampItemID;                                        // 0x0460(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                GroupID;                                                  // 0x0464(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UActorComponent*>                     TeamAIComponents;                                         // 0x0468(0x000C) (ExportObject, ZeroConstructor)
...
public:
	...
	bool                                               CheckVisible;                                             // 0x0170(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0171(0x0003) MISSED OFFSET
	TArray<class UStaticMeshComponent*>                CheckVisibleMeshComponents;                               // 0x0174(0x000C) (ExportObject, ZeroConstructor)
	uint32_t                                           CustomUInt32State;                                        // 0x0180(0x0004) (ZeroConstructor, IsPlainOldData)
...
// 0x0F08 (0x1058 - 0x0150)
class UAIStateInfoComponentBase : public UAIBasicStateInfoComponent
{
public:
	struct FAIStateInfoBaseMod                         CacheAIStateInfoBaseMod;                                  // 0x0150(0x0338)
	struct FAIStateInfoBaseMod                         LastAIStateInfoBaseMod;                                   // 0x0488(0x0338)
	struct FDiffAIStateInfoBaseModGeneral              CacheDiffAIStateInfoBaseModGeneral;                       // 0x07C0(0x0460)
	struct FDiffAIStateInfoBaseMod                     CacheDiffAIStateInfoBaseMod;                              // 0x0C20(0x0328)
	bool                                               IsTouchedPlayer;                                          // 0x0F48(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0F49(0x0003) MISSED OFFSET
	uint32_t                                           FrameNo;                                                  // 0x0F4C(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x0F50(0x0004) (ZeroConstructor, IsPlainOldData)
	class AController*                                 OwnerController;                                          // 0x0F54(0x0004) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x0F58(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAIActingComponent*                          AIActingComp;                                             // 0x0F5C(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class APawn*                                       MyOwnerPawn;                                              // 0x0F60(0x0004) (ZeroConstructor, IsPlainOldData)
	class ABattleRoyaleGameModeBase*                   MyGameMode;                                               // 0x0F64(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6C];                                      // 0x0F68(0x006C) MISSED OFFSET
	TArray<struct FVehicleDamageInfo>                  VehicleDamageInfo;                                        // 0x0FD4(0x000C) (ZeroConstructor)
	TMap<int, class APickUpWrapperActor*>              CacheAINearbyItem;                                        // 0x0FE0(0x0050) (ZeroConstructor)
	TArray<class ASTExtraBaseCharacter*>               CacheNearbyEnemies;                                       // 0x101C(0x000C) (ZeroConstructor)
	struct FCacheNearbyItemState                       CacheNearbyItemState;                                     // 0x1028(0x001C)
	class UMLAIControllerComponent*                    MyMLAIControllerComp;                                     // 0x1044(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	uint32_t                                           CacheModeMapId;                                           // 0x1048(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x104C(0x000C) MISSED OFFSET
...
// 0x0638 (0x1690 - 0x1058)
class UAIStateInfoComponentBRBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoBRBase                          CacheAIStateInfoBRBase;                                   // 0x1058(0x0188)
	struct FAIStateInfoBRBase                          LastAIStateInfoBRBase;                                    // 0x11E0(0x0188)
	struct FDiffAIStateInfoBRBaseGeneral               CacheDiffAIStateInfoBRBaseGeneral;                        // 0x1368(0x01E8)
	struct FDiffAIStateInfoBRBase                      CacheDiffAIStateInfoBRBase;                               // 0x1550(0x0140)
...
// 0x0178 (0x11D0 - 0x1058)
class UAIStateInfoComponentMPBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoMPBase                          CacheAIStateInfoMPBase;                                   // 0x1058(0x0078)
	struct FAIStateInfoMPBase                          LastAIStateInfoMPBase;                                    // 0x10D0(0x0078)
	struct FDiffAIStateInfoMPBaseGeneral               CacheDiffAIStateInfoMPBaseGeneral;                        // 0x1148(0x0088)
...
// 0x00A8 (0x1278 - 0x11D0)
class UAIStateInfoComponentTeamDeath : public UAIStateInfoComponentMPBase
{
public:
	struct FAIStateInfoTeamDeath                       CacheAIStateInfoTeamDeath;                                // 0x11D0(0x0038)
	struct FAIStateInfoTeamDeath                       LastAIStateInfoTeamDeath;                                 // 0x1208(0x0038)
	struct FDiffAIStateInfoTeamDeathGeneral            CacheDiffAIStateInfoTeamDeathGeneral;                     // 0x1240(0x0038)
...
public:
	...
	TArray<int>                                        AvailableBackpackItemTypes;                               // 0x005C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TMap<int, bool>                                    AvailableNearbyItemTypes;                                 // 0x0068(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	TMap<int, int>                                     GrenadeTypeConfig;                                        // 0x00A4(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	TMap<int, int>                                     EquipmentItemIDMappingConfig;                             // 0x00E0(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              VisibleAngle;                                             // 0x011C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     HeadOffset;                                               // 0x0120(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              NearbyEnemyRange;                                         // 0x012C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	float                                              FogWeatherRangeScale;                                     // 0x0130(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	int                                                NearbyEnemyMaxNum;                                        // 0x0134(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsSearchNearItem;                                         // 0x0138(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0139(0x0003) MISSED OFFSET
	int                                                NearbyItemMaxNum;                                         // 0x013C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyMaxBoxNum;                                          // 0x0140(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyAirDropBoxRangeInner;                               // 0x0144(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyAirDropBoxRangeOuter;                               // 0x0148(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyDeathBoxRange;                                      // 0x014C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyPickUpWrapperRange;                                 // 0x0150(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CacheNearbyItemRangeCoefficient;                          // 0x0154(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyMaxTreasureChestNum;                                // 0x0158(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyTreasureChestRange;                                 // 0x015C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyMaxWeedNum;                                         // 0x0160(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyWeedRange;                                          // 0x0164(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyFindBuildingRange;                                  // 0x0168(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ItemStateChangedRange;                                    // 0x016C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsItemVisiable;                                           // 0x0170(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUseItemSpotLoc;                                         // 0x0171(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0172(0x0002) MISSED OFFSET
	float                                              NearbyObstacleRange;                                      // 0x0174(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyThrownRange;                                        // 0x0178(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbySmokeRange;                                         // 0x017C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyThrownMaxNum;                                       // 0x0180(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0184(0x0004) MISSED OFFSET
	int                                                NearbyDoorMaxNum;                                         // 0x0188(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyVehicleRange;                                       // 0x018C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	int                                                NearbyVehicleMaxNum;                                      // 0x0190(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyBulletHoleRange;                                    // 0x0194(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyBulletHoleMaxNum;                                   // 0x0198(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyDynamicItemsRange;                                  // 0x019C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyDynamicItemsMaxNum;                                 // 0x01A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyMonsterRange;                                       // 0x01A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyMonsterMaxNum;                                      // 0x01A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreTreeAIWhenNoPlayerAround;                          // 0x01AC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x01AD(0x0003) MISSED OFFSET
	float                                              IgnoreTreeAIRadius;                                       // 0x01B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               UseBodyTPPCamera;                                         // 0x01B4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x01B5(0x0003) MISSED OFFSET
	TArray<int>                                        IgnoredMonsterIDs;                                        // 0x01B8(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EAvatarSlotType>                            AvailableAvatarSlotTypes;                                 // 0x01C4(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
public:
	...
	class UAIStateInfoDataAsset*                       AIStateInfoDataAsset;                                     // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMLAIStateInfoManager*                       MLAIStateInfoManager;                                     // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       LastAllPlayerStateInfoMap;                                // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       CurrentAllPlayerStateInfoMap;                             // 0x0064(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       CacheAllPlayersInfo;                                      // 0x00A0(0x0050) (ZeroConstructor)
	struct FDiffAllMLAIInfoBaseModGeneral              CacheDiffAllPlayersInfoGeneral;                           // 0x00DC(0x00C0)
	struct FDiffAllMLAIInfoBaseMod                     CacheAllPlayersInfoCSS;                                   // 0x019C(0x0084)
...
{
public:
	TMap<uint32_t, struct FAIBaseStateInfo>            LastAllPlayerStateInfoMap;                                // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBaseStateInfo>            CurrentAllPlayerStateInfoMap;                             // 0x0064(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBaseStateInfo>            CacheAllPlayersInfo;                                      // 0x00A0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerBaseInfoGeneral               CacheDiffAllPlayersInfoGeneral;                           // 0x00DC(0x00D0)
	unsigned char                                      UnknownData00[0x4];                                       // 0x01AC(0x0004) MISSED OFFSET
	struct FDiffAllPlayerBaseInfo                      CacheAllPlayersInfoCSS;                                   // 0x01B0(0x0308)
	struct FGlobalGameBaseState                        CacheGlobalGameState;                                     // 0x04B8(0x0050)
	struct FGlobalGameBaseState                        LastGlobalGameState;                                      // 0x0508(0x0050)
	struct FDiffGlobalGameBaseState                    DiffGlobalGameState;                                      // 0x0558(0x0050)
	struct FDiffGlobalGameBaseStateGeneral             DiffGlobalGameStateGeneral;                               // 0x05A8(0x0050)
	TMap<uint32_t, uint32_t>                           DiffStateInfoKeyMap;                                      // 0x05F8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x34];                                      // 0x0634(0x0034) MISSED OFFSET
...
{
public:
	TMap<uint32_t, struct FAIBRBaseStateInfo>          LastAllPlayerStateInfoMap;                                // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          CurrentAllPlayerStateInfoMap;                             // 0x0064(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          CacheAllPlayersInfo;                                      // 0x00A0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerBRBaseInfoGeneral             CacheDiffAllPlayersInfoGeneral;                           // 0x00DC(0x00C0)
	struct FDiffAllPlayerBRBaseInfo                    CacheAllPlayersInfoCSS;                                   // 0x019C(0x03C0)
	struct FGlobalGameBRBaseState                      CacheGlobalGameState;                                     // 0x055C(0x00E0)
	struct FGlobalGameBRBaseState                      LastGlobalGameState;                                      // 0x063C(0x00E0)
	struct FDiffGlobalGameBRBaseState                  DiffGlobalGameState;                                      // 0x071C(0x00F4)
	struct FDiffGlobalGameBRBaseStateGeneral           DiffGlobalGameStateGeneral;                               // 0x0810(0x0128)
...
{
public:
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     LastAllPlayerStateInfoMap;                                // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     CurrentAllPlayerStateInfoMap;                             // 0x0064(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     CacheAllPlayersInfo;                                      // 0x00A0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerDynamicItemInfoGeneral        CacheDiffAllPlayersInfoGeneral;                           // 0x00DC(0x00C0)
	struct FDiffAllPlayerDynamicItemInfo               CacheAllPlayersInfoCSS;                                   // 0x019C(0x00E4)
	struct FGlobalDynamicItemState                     CacheGlobalGameState;                                     // 0x0280(0x0024)
	struct FGlobalDynamicItemState                     LastGlobalGameState;                                      // 0x02A4(0x0024)
	struct FDiffGlobalDynamicItemState                 DiffGlobalGameState;                                      // 0x02C8(0x003C)
	struct FDiffGlobalDynamicItemStateGeneral          DiffGlobalGameStateGeneral;                               // 0x0304(0x003C)
	TMap<uint64_t, struct FDynamicItem>                CacheDynamicItems;                                        // 0x0340(0x0050) (ZeroConstructor)
...
{
public:
	TMap<uint32_t, struct FAIDoorStateInfo>            LastAllPlayerStateInfoMap;                                // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDoorStateInfo>            CurrentAllPlayerStateInfoMap;                             // 0x0064(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDoorStateInfo>            CacheAllPlayersInfo;                                      // 0x00A0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerDoorInfoGeneral               CacheDiffAllPlayersInfoGeneral;                           // 0x00DC(0x00C0)
	struct FDiffAllPlayerDoorInfo                      CacheAllPlayersInfoCSS;                                   // 0x019C(0x00E4)
	struct FGlobalDoorState                            CacheGlobalGameState;                                     // 0x0280(0x0024)
	struct FGlobalDoorState                            LastGlobalGameState;                                      // 0x02A4(0x0024)
	struct FDiffGlobalDoorState                        DiffGlobalGameState;                                      // 0x02C8(0x003C)
	struct FDiffGlobalDoorStateGeneral                 DiffGlobalGameStateGeneral;                               // 0x0304(0x003C)
	TMap<uint64_t, struct FDoorState>                  CacheDoorStates;                                          // 0x0340(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x037C(0x0004) MISSED OFFSET
...
{
public:
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   LastAllPlayerStateInfoMap;                                // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   CurrentAllPlayerStateInfoMap;                             // 0x0064(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   CacheAllPlayersInfo;                                      // 0x00A0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerNearbyMonsterGeneral          CacheDiffAllPlayersInfoGeneral;                           // 0x00DC(0x00C0)
	struct FDiffAllPlayerNearbyMonsterInfo             CacheAllPlayersInfoCSS;                                   // 0x019C(0x00E4)
	struct FGlobalMonsterState                         CacheGlobalGameState;                                     // 0x0280(0x0024)
	struct FGlobalMonsterState                         LastGlobalGameState;                                      // 0x02A4(0x0024)
	struct FDiffGlobalMonsterState                     DiffGlobalGameState;                                      // 0x02C8(0x003C)
	TMap<uint64_t, struct FMonsterState>               CacheMonsterStats;                                        // 0x0304(0x0050) (ZeroConstructor)
	struct FDiffGlobalMonsterStateGeneral              DiffGlobalGameStateGeneral;                               // 0x0340(0x003C)
	unsigned char                                      UnknownData00[0x4];                                       // 0x037C(0x0004) MISSED OFFSET
...
{
public:
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    LastAllPlayerStateInfoMap;                                // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    CurrentAllPlayerStateInfoMap;                             // 0x0064(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    CacheAllPlayersInfo;                                      // 0x00A0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerNearbyPlayerInfoGeneral       CacheDiffAllPlayersInfoGeneral;                           // 0x00DC(0x00C0)
	struct FDiffAllPlayerNearbyPlayerInfo              CacheAllPlayersInfoCSS;                                   // 0x019C(0x0084)
...
{
public:
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> LastAllPlayerStateInfoMap;                                // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> CurrentAllPlayerStateInfoMap;                             // 0x0064(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> CacheAllPlayersInfo;                                      // 0x00A0(0x0050) (ZeroConstructor)
	struct FDiffAllMLAINearbyInfoBaseModGeneral        CacheDiffAllPlayersInfoGeneral;                           // 0x00DC(0x00C0)
	struct FDiffAllMLAINearbyInfoBaseMod               CacheAllPlayersInfoCSS;                                   // 0x019C(0x0114)
	struct FGlobalNearbyStateBaseMod                   CacheGlobalGameState;                                     // 0x02B0(0x003C)
	struct FGlobalNearbyStateBaseMod                   LastGlobalGameState;                                      // 0x02EC(0x003C)
	struct FDiffGlobalNearbyStateBaseMod               DiffGlobalGameState;                                      // 0x0328(0x0054)
	struct FDiffGlobalNearbyStateBaseModGeneral        DiffGlobalGameStateGeneral;                               // 0x037C(0x0084)
	TMap<uint64_t, struct FItemStateData>              CacheItemData;                                            // 0x0400(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FAINearbyThrown>             CacheAINearbyThrown;                                      // 0x043C(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FObstacleState>              CacheObstacleStates;                                      // 0x0478(0x0050) (ZeroConstructor)
...
public:
	...
	bool                                               bDiffSwitch;                                              // 0x006A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x006B(0x0001) MISSED OFFSET
	class UAIStateInfoDataAsset*                       AIStateInfoDataAsset;                                     // 0x006C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UStateInfoCollectorBase*>             StateInfoCollectorList;                                   // 0x0070(0x000C) (ZeroConstructor)
	TMap<struct FString, class UClass*>                CollectorNameToClassMap;                                  // 0x007C(0x0050) (ZeroConstructor)
	TMap<class ASTExtraPlayerCharacter*, bool>         CacheMLAIs;                                               // 0x00B8(0x0050) (ZeroConstructor)
	TMap<class ASTExtraPlayerCharacter*, bool>         CachePlayerAndBTAIs;                                      // 0x00F4(0x0050) (ZeroConstructor)
	TMap<uint32_t, bool>                               CacheCandidateAIs;                                        // 0x0130(0x0050) (ZeroConstructor)
	TMap<uint32_t, bool>                               AlreadySendDeadStateMap;                                  // 0x016C(0x0050) (ZeroConstructor)
	TMap<uint32_t, int>                                CachePlayerType;                                          // 0x01A8(0x0050) (ZeroConstructor)
	TMap<EDiffListIDTag, struct FDiffListIDMap>        DiffPlayerIDToListIDMap;                                  // 0x01E4(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FPropertyNameListIDMap>      DiffAIPlayerInfoListIDMaps;                               // 0x0220(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x1C];                                      // 0x025C(0x001C) MISSED OFFSET
...
public:
	...
	TMap<uint32_t, struct FAIPlayerInteractInfo>       CachePlayerDamageInfo;                                    // 0x002C(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FVehicleDamageInfoContainer> CacheVehicleDamageInfo;                                   // 0x0068(0x0050) (ZeroConstructor)
	int                                                MaxCacheDamageInfoNum;                                    // 0x00A4(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<class UAIBasicStateInfoComponent*>          AIStateInfoComps;                                         // 0x00A8(0x000C) (ExportObject, ZeroConstructor)
	TArray<struct FBulletHoleRecordInfo>               CacheBulletHoles;                                         // 0x00B4(0x000C) (ZeroConstructor)
	TArray<int>                                        PlayerAvailableBackpackItemTypes;                         // 0x00C0(0x000C) (ZeroConstructor)
	TArray<struct FString>                             TeammateStateWhiteList;                                   // 0x00CC(0x000C) (ZeroConstructor)
	TArray<TWeakObjectPtr<class AAirDropBoxActor>>     AirDropBoxActors;                                         // 0x00D8(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x3C];                                      // 0x00E4(0x003C) MISSED OFFSET
	TMap<uint32_t, bool>                               AlreadySendDeadStateMap;                                  // 0x0120(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x015C(0x0004) MISSED OFFSET
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x0160(0x0024)
	float                                              AirAttackTotalTime;                                       // 0x0184(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAirAttackComponent*                         AirAttackComp;                                            // 0x0188(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FGlobalGameStateBRBase                      GlobalGameState;                                          // 0x018C(0x011C)
	struct FGlobalGameStateBRBase                      LastGlobalGameState;                                      // 0x02A8(0x011C)
	class UMLAIUtilsBase*                              MlaiUtils;                                                // 0x03C4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x18];                                      // 0x03C8(0x0018) MISSED OFFSET
	TMap<uint32_t, int>                                CachePlayerRevivalTypes;                                  // 0x03E0(0x0050) (ZeroConstructor)
	class UMLAIStateInfoManager*                       MLAIStateInfoManager;                                     // 0x041C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AirDropTag;                                               // 0x0420(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0424(0x0008) MISSED OFFSET
	TMap<class AActor*, class ASpecialZoneActor*>      CacheSpecialZoneParents;                                  // 0x042C(0x0050) (ZeroConstructor)
...
// 0x06C4 (0x06E0 - 0x001C)
class UMLAIUtilsBase : public UObject
{
public:
	unsigned char                                      UnknownData00[0x40];                                      // 0x001C(0x0040) MISSED OFFSET
	struct FString                                     LuaFilePath;                                              // 0x005C(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	class UAIStateInfoDataAsset*                       AIStateInfoDataAsset;                                     // 0x0068(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseGlobalNearbyInfo;                                     // 0x006C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bNeedDebugNearbyInfo;                                     // 0x006D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x006E(0x0002) MISSED OFFSET
	TMap<uint64_t, struct FItemStateData>              CacheItemData;                                            // 0x0070(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FAINearbyThrown>             CacheAINearbyThrown;                                      // 0x00AC(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FObstacleState>              CacheObstacleStates;                                      // 0x00E8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0124(0x0004) MISSED OFFSET
	struct FGlobalGameStateBaseMod                     CacheGlobalGameStateBaseMod;                              // 0x0128(0x0080)
	struct FGlobalGameStateBaseMod                     LastGlobalGameStateBaseMod;                               // 0x01A8(0x0080)
	struct FDiffGlobalGameStateBaseMod                 DiffGlobalGameStateBaseMod;                               // 0x0228(0x0098)
	struct FDiffGlobalGameStateBaseModGeneral          DiffGlobalGameStateBaseModGeneral;                        // 0x02C0(0x00C8)
	struct FDiffListIDMap                              DiffPlayerIDToListIDMap;                                  // 0x0388(0x003C)
	TMap<uint64_t, struct FPropertyNameListIDMap>      DiffAIPlayerInfoListIDMaps;                               // 0x03C4(0x0050) (ZeroConstructor)
	TArray<struct FAIStateInfoBaseMod>                 CacheAllPlayersInfoBaseMod;                               // 0x0400(0x000C) (ZeroConstructor)
	struct FDiffAllPlayerInfoBaseModGeneral            CacheDiffAllPlayersInfoBaseModGeneral;                    // 0x040C(0x0070)
	unsigned char                                      UnknownData03[0x4];                                       // 0x047C(0x0004) MISSED OFFSET
	struct FDiffAllPlayerInfoBaseMod                   CacheAllPlayersInfoBaseModCSS;                            // 0x0480(0x01A0)
	TMap<uint32_t, struct FAIStateInfoBaseMod>         LastAllPlayerInfoMapBaseMod;                              // 0x0620(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIStateInfoBaseMod>         CacheAllPlayersInfoMapBaseMod;                            // 0x065C(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x30];                                      // 0x0698(0x0030) MISSED OFFSET
	TArray<class ASTExtraPlayerCharacter*>             CacheMLAIs;                                               // 0x06C8(0x000C) (ZeroConstructor)
	TArray<class ASTExtraPlayerCharacter*>             CachePlayerAndBTAIs;                                      // 0x06D4(0x000C) (ZeroConstructor)
	...
	void StartRequestCache();
	static void SetUseNewDiffCmds(bool InUseNewDiffCmds);
...
// 0x0950 (0x1030 - 0x06E0)
class UMLAIUtilsBRBase : public UMLAIUtilsBase
{
public:
	TMap<uint64_t, struct FDoorState>                  CacheDoorStates;                                          // 0x06E0(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FVehicleState>               CacheVehicleStates;                                       // 0x071C(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FDynamicItem>                CacheDynamicItems;                                        // 0x0758(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FMonsterState>               CacheMonsterStats;                                        // 0x0794(0x0050) (ZeroConstructor)
	struct FGlobalGameStateBRBase                      CacheGlobalGameStateBRBase;                               // 0x07D0(0x011C)
	struct FGlobalGameStateBRBase                      LastGlobalGameStateBRBase;                                // 0x08EC(0x011C)
	struct FDiffGlobalGameStateBRBase                  DiffGlobalGameStateBRBase;                                // 0x0A08(0x00F4)
	struct FDiffGlobalGameStateBRBaseGeneral           DiffGlobalGameStateBRBaseGeneral;                         // 0x0AFC(0x01C4)
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x0CC0(0x0024)
	TArray<struct FAIStateInfoBRBase>                  CacheAllPlayersInfoBRBase;                                // 0x0CE4(0x000C) (ZeroConstructor)
	struct FDiffAllPlayerInfoBRBaseGeneral             CacheDiffAllPlayersInfoBRBaseGeneral;                     // 0x0CF0(0x006C)
	struct FDiffAllPlayerInfoBRBase                    CacheAllPlayersInfoBRBaseCSS;                             // 0x0D5C(0x027C)
	TMap<uint32_t, struct FAIStateInfoBRBase>          LastAllPlayerInfoMapBRBase;                               // 0x0FD8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x1C];                                      // 0x1014(0x001C) MISSED OFFSET
...
{
public:
	struct FGlobalGameStateMPBase                      CacheGlobalGameStateMPBase;                               // 0x06E0(0x0024)
	struct FGlobalGameStateMPBase                      LastGlobalGameStateMPBase;                                // 0x0704(0x0024)
	struct FDiffGlobalGameStateMPBaseGeneral           DiffGlobalGameStateMPBaseGeneral;                         // 0x0728(0x0030)
	TArray<struct FAIStateInfoMPBase>                  CacheAllPlayersInfoMPBase;                                // 0x0758(0x000C) (ZeroConstructor)
	struct FDiffAllPlayerInfoMPBaseGeneral             CacheDiffAllPlayersInfoMPBaseGeneral;                     // 0x0764(0x006C)
	TMap<uint32_t, struct FAIStateInfoMPBase>          LastAllPlayerInfoMapMPBase;                               // 0x07D0(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x1C];                                      // 0x080C(0x001C) MISSED OFFSET
...
{
public:
	TMap<uint32_t, struct FAIMPStateInfo>              LastAllPlayerStateInfoMap;                                // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIMPStateInfo>              CurrentAllPlayerStateInfoMap;                             // 0x0064(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIMPStateInfo>              CacheAllPlayersInfo;                                      // 0x00A0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerMPBaseInfoGeneral             CacheDiffAllPlayersInfoGeneral;                           // 0x00DC(0x00CC)
	struct FGlobalGameMPState                          CacheGlobalGameState;                                     // 0x01A8(0x0024)
	struct FGlobalGameMPState                          LastGlobalGameState;                                      // 0x01CC(0x0024)
	struct FDiffGlobalGameBRBaseState                  DiffGlobalGameState;                                      // 0x01F0(0x00F4)
	struct FDiffGlobalGameBRBaseStateGeneral           DiffGlobalGameStateGeneral;                               // 0x02E4(0x0128)
	unsigned char                                      UnknownData00[0x1C];                                      // 0x040C(0x001C) MISSED OFFSET
...
public:
	...
	int                                                Type;                                                     // 0x033C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsDynamic;                                                // 0x0340(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0341(0x0003) MISSED OFFSET
	int                                                CustomState;                                              // 0x0344(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USpecialZoneShapeComponent*                  SpecialZoneShapeComponent;                                // 0x0348(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AActor*                                      CacheParentActor;                                         // 0x034C(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class ASTExtraVehicleBase*                         ControlledVehicle;                                        // 0x05D8(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIVehicleStateData                         AIVehicleStateData;                                       // 0x05DC(0x0078)
	class UAIBehaviorAdapter_VehicleBase*              AIBehaviorAdapter;                                        // 0x0654(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	TMap<uint32_t, struct FAIVehicleStateInfo>         LastAllPlayerStateInfoMap;                                // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIVehicleStateInfo>         CurrentAllPlayerStateInfoMap;                             // 0x0064(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIVehicleStateInfo>         CacheAllPlayersInfo;                                      // 0x00A0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerVehicleInfoGeneral            CacheDiffAllPlayersInfoGeneral;                           // 0x00DC(0x00C0)
	struct FDiffAllPlayerVehicleInfo                   CacheAllPlayersInfoCSS;                                   // 0x019C(0x024C)
	struct FGlobalVehicleState                         CacheGlobalGameState;                                     // 0x03E8(0x0024)
	struct FGlobalVehicleState                         LastGlobalGameState;                                      // 0x040C(0x0024)
	struct FDiffGlobalVehicleState                     DiffGlobalGameState;                                      // 0x0430(0x003C)
	struct FDiffGlobalVehicleStateGeneral              DiffGlobalGameStateGeneral;                               // 0x046C(0x003C)
	TMap<uint64_t, struct FVehicleState>               CacheVehicleStates;                                       // 0x04A8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x1C];                                      // 0x04E4(0x001C) MISSED OFFSET
