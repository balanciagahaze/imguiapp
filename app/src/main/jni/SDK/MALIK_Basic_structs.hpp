...
struct FTableNameToName
{
	...
	struct FName                                       LobbyPath;                                                // 0x0020(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       WrapperPath;                                              // 0x0028(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       Custom1;                                                  // 0x0030(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FPickupSetting
{
	...
	TMap<int, int>                                     LimitSeasonItemMap;                                       // 0x0178(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
};
