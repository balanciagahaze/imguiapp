...
{
public:
	TArray<struct FVector>                             PortalLoctions;                                           // 0x0338(0x000C) (Edit, ZeroConstructor)
...
{
public:
	class UClass*                                      CharacterClass;                                           // 0x0C50(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0C54(0x0004) MISSED OFFSET
