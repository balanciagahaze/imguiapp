...
// Function Gameplay.UAELevelSequenceActor.IsStartPlayTimeValid
// (Final, Native, Public)
// Parameters:
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool AUAELevelSequenceActor::IsStartPlayTimeValid()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Gameplay.UAELevelSequenceActor.IsStartPlayTimeValid");

	AUAELevelSequenceActor_IsStartPlayTimeValid_Params params;
