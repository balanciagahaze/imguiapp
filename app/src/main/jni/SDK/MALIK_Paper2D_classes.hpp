...
{
public:
	class UPaperFlipbookComponent*                     Sprite;                                                   // 0x0650(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData00[0xC];                                       // 0x0654(0x000C) MISSED OFFSET
...
{
public:
	float                                              PlayRate;                                                 // 0x06E0(0x0004) (Edit, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bLooping : 1;                                             // 0x06E4(0x0001) (Net)
	unsigned char                                      bReversePlayback : 1;                                     // 0x06E4(0x0001) (Net)
	unsigned char                                      bPlaying : 1;                                             // 0x06E4(0x0001) (Net)
	unsigned char                                      UnknownData00[0x3];                                       // 0x06E5(0x0003) MISSED OFFSET
	float                                              AccumulatedTime;                                          // 0x06E8(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	int                                                CachedFrameIndex;                                         // 0x06EC(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                SpriteColor;                                              // 0x06F0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	class UBodySetup*                                  CachedBodySetup;                                          // 0x0700(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnFinishedPlaying;                                        // 0x0704(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	TArray<struct FSpriteInstanceData>                 PerInstanceSpriteData;                                    // 0x06E4(0x000C) (Edit, ZeroConstructor)
...
{
public:
	struct FLinearColor                                SpriteColor;                                              // 0x06E0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
...
{
public:
	class UPaperTerrainSplineComponent*                SplineComponent;                                          // 0x0338(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UPaperTerrainComponent*                      RenderComponent;                                          // 0x033C(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	int                                                TileWidth;                                                // 0x06E0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	int                                                TileHeight;                                               // 0x06E4(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UPaperTileSet*                               DefaultLayerTileSet;                                      // 0x06E8(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UMaterialInterface*                          Material;                                                 // 0x06EC(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	TArray<class UPaperTileLayer*>                     TileLayers;                                               // 0x06F0(0x000C) (ZeroConstructor, Deprecated)
	struct FLinearColor                                TileMapColor;                                             // 0x06FC(0x0010) (Edit, IsPlainOldData)
	int                                                UseSingleLayerIndex;                                      // 0x070C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseSingleLayer;                                          // 0x0710(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0711(0x0003) MISSED OFFSET
	class UPaperTileMap*                               TileMap;                                                  // 0x0714(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
