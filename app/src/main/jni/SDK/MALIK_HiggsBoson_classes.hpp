...
public:
	...
	unsigned char                                      UnknownData02[0x43C];                                     // 0x0074(0x043C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x100];                                     // 0x0174(0x0100) MISSED OFFSET
	struct FString                                     TraceData;                                                // 0x0274(0x000C) (ZeroConstructor)
	struct FString                                     GameTraceData;                                            // 0x0280(0x000C) (ZeroConstructor)
	uint32_t                                           HeartBreaks;                                              // 0x028C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     HeartInfo;                                                // 0x0290(0x000C) (ZeroConstructor)
	struct FScriptMulticastDelegate                    OnSwiftHawkDelegate;                                      // 0x029C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class ASTExtraBaseCharacter*                       CharacterOwner;                                           // 0x02A8(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    PlayerController;                                         // 0x02AC(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bClientInfoReceived;                                      // 0x02B0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x02B1(0x0003) MISSED OFFSET
	TArray<uint32_t>                                   ClientInfoAsUInt32Array;                                  // 0x02B4(0x000C) (ZeroConstructor)
	TArray<unsigned char>                              IntegrityItemCheckResultAsBytes;                          // 0x02C0(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x38];                                      // 0x02CC(0x0038) MISSED OFFSET
	bool                                               bRoofTouchActive;                                         // 0x0304(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0xB];                                       // 0x0305(0x000B) MISSED OFFSET
	int                                                RoofTouchStatus;                                          // 0x0310(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x75C];                                     // 0x0314(0x075C) MISSED OFFSET
	class USCoronaClientData*                          SecurityCoronaLabClientDataPointer;                       // 0x0A70(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x5C];                                      // 0x0A74(0x005C) MISSED OFFSET
	TArray<struct FString>                             MatchedApps;                                              // 0x0AD0(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData07[0x14];                                      // 0x0ADC(0x0014) MISSED OFFSET
	TArray<struct FString>                             ReceivedInstalledApp;                                     // 0x0AF0(0x000C) (ZeroConstructor)
	struct FScriptMulticastDelegate                    OnServerReceiveInstalledAppDelegate;                      // 0x0AFC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData08[0x1C];                                      // 0x0B08(0x001C) MISSED OFFSET
	int                                                ReceivedRotationModifiedCount;                            // 0x0B24(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedTranslationModifiedCount;                         // 0x0B28(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedScale3DModifiedCount;                             // 0x0B2C(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        LastInvalidIndexListInPakLite;                            // 0x0B30(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData09[0x4];                                       // 0x0B3C(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnServerReceiveInvalidFilesInPakLiteDelegate;             // 0x0B40(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData10[0xB8];                                      // 0x0B4C(0x00B8) MISSED OFFSET
	float                                              TouchScreenActiveTimeRatioThreshold;                      // 0x0C04(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0C08(0x0004) MISSED OFFSET
	float                                              MouTa;                                                    // 0x0C0C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                BandaCountThreshold;                                      // 0x0C10(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bEnableBandCount;                                         // 0x0C14(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x0C15(0x0003) MISSED OFFSET
	float                                              IntervalThreshold1;                                       // 0x0C18(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HongThreshold;                                            // 0x0C1C(0x0004) (ZeroConstructor, IsPlainOldData)
