...
// Function Client.ScriptHelperClient.VisitRemapJVM
struct UScriptHelperClient_VisitRemapJVM_Params
{
};
...
// Function Client.ScriptHelperClient.TestRemapJVM
struct UScriptHelperClient_TestRemapJVM_Params
{
...
// Function Client.VoiceSDKInterface.EnableCampVoice
struct UVoiceSDKInterface_EnableCampVoice_Params
{
	bool                                               Enable;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
};
