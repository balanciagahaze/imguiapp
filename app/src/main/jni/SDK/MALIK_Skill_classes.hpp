...
public:
	...
	bool                                               bNeedSync;                                                // 0x03D4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03D5(0x0003) MISSED OFFSET
	struct FString                                     SkillName;                                                // 0x03D8(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	...
	unsigned char                                      UnknownData05[0x3];                                       // 0x0451(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData06[0x3F];                                      // 0x04C1(0x003F) MISSED OFFSET
...
public:
	...
	TArray<int>                                        PendingRemoveSkillID;                                     // 0x0684(0x000C) (ZeroConstructor)
	TArray<struct FUTReplaceSkillData>                 ReplacedSkillDatas;                                       // 0x0690(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	TMap<int, struct FSkillDisableKeySet>              DisableSkillTagsMap;                                      // 0x069C(0x0050) (ZeroConstructor)
	struct FMultiSkillSynData                          NewSkillSynData;                                          // 0x06D8(0x00B4) (BlueprintVisible, Net)
	struct FSkillSinglePhaseData                       NewSkillSinglePhaseData;                                  // 0x078C(0x00B4) (BlueprintVisible, Net)
	TMap<uint64_t, struct FUTSkillSimulateData>        SkillSimulateDataMap;                                     // 0x0840(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData07[0x3C];                                      // 0x087C(0x003C) UNKNOWN PROPERTY: SetProperty Skill.UTSkillManagerComponent.AsyncLoadingSkillInst
	struct FUTSkillExecQueue                           SkillExecQueue;                                           // 0x08B8(0x0084)
	unsigned char                                      UnknownData08[0x4];                                       // 0x093C(0x0004) MISSED OFFSET
	uint64_t                                           NetClientSimulateInstID;                                  // 0x0940(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x10];                                      // 0x0948(0x0010) MISSED OFFSET
