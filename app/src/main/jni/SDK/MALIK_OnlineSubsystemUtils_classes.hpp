...
public:
	...
	class UNetDriver*                                  NetDriver;                                                // 0x0340(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x0350(0x0004) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x0354(0x0004) (ZeroConstructor, IsPlainOldData)
	EBeaconConnectionState                             ConnectionState;                                          // 0x0358(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x27];                                      // 0x0359(0x0027) MISSED OFFSET
...
public:
	...
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0354(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x78];                                      // 0x0360(0x0078) MISSED OFFSET
...
public:
	...
	class UClass*                                      ClientBeaconActorClass;                                   // 0x0340(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0344(0x000C) (ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0x14];                                      // 0x0380(0x0014) MISSED OFFSET
	struct FString                                     DestSessionId;                                            // 0x0394(0x000C) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x03A0(0x001C)
	EClientRequestType                                 RequestType;                                              // 0x03BC(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x03BD(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x03BE(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x29];                                      // 0x03BF(0x0029) MISSED OFFSET
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x0350(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x28];                                      // 0x0354(0x0028) MISSED OFFSET
	bool                                               bLogoutOnSessionTimeout;                                  // 0x037C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x037D(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0380(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x0384(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
